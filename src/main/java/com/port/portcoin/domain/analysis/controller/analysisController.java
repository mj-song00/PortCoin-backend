...
public class analysisController {
    ...
    public ResponseEntity<ApiResponse<UserSummeryResponse>> getResult(
            @Auth AuthUser authUser
    ){
       UserSummeryResponse result = ananlysisService.getSummeryResult(authUser);
       ApiResponse<UserSummeryResponse> response = ApiResponse.successWithData(result, ApiResponseEnum.GET_SUCCESS);
